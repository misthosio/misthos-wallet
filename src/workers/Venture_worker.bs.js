...
function loadAndNotify(notify, $staropt$star, data, correlationId, ventureId) {
  ...
  return Venture.load(/* Some */[persist], data, ventureId).then((function (param) {
                if (param.tag) {
                  if (notify) {
                    cmdError(ventureId, correlationId, /* CouldNotLoadVenture */1);
                  }
                  throw [
                        DeadThread,
                        param[0]
                              ...
                              case 0 : 
                                  ...
                                  match = /* tuple */[
                                    ...
                                    match$1[1].then((function (param) {
                                            if (param.tag) {
                                              cmdError(ventureId, correlationId, /* CouldNotPersistVenture */6);
                                              throw [
                                                    DeadThread,
                                                    param[0]
                                                  ];
      ...
      return withVenture(/* None */0, partial_arg, (function (correlationId, venture) {
                    return Curry._2(Venture.Cmd[/* ProposePartner */3][/* exec */0], prospectId, venture).then((function (param) {
                                  if (typeof param === "number") {
                                    switch (param) {
                                      case 0 : 
                                          cmdError(ventureId, correlationId, /* MaxPartnersReached */2);
                                          return Promise.resolve(venture);
                                      case 1 : 
                                          cmdError(ventureId, correlationId, /* PartnerAlreadyProposed */4);
                                          return Promise.resolve(venture);
                                      case 2 : 
                                          cmdError(ventureId, correlationId, /* PartnerAlreadyExists */3);
                                          return Promise.resolve(venture);
                                      case 3 : 
                                          cmdError(ventureId, correlationId, /* CouldNotFindUserInfo */5);
                                          return Promise.resolve(venture);
...
function syncWallet(ventureId, broadcasts, broadcastFailures, income, confs) {
  logMessage("Handling 'SynchWallet'");
  var partial_arg = /* Load */Block.__(1, [ventureId]);
  return (function (param, param$1) {
      return withVenture(/* None */0, partial_arg, (function (correlationId, venture) {
                    return Curry._5(Venture.Cmd[/* SynchronizeWallet */2][/* exec */0], broadcasts, broadcastFailures, income, confs, venture).then((function (param) {
                                  if (param.tag) {
                                    return Promise.resolve(venture);
                                  } else {
                                    newItems(correlationId, ventureId, param[1]);
