                              ...
                              case 0 : 
                                  ...
                                  match = /* tuple */[
                                    ...
                                    match$1[1].then((function (param) {
                                            if (param.tag) {
                                              cmdError(ventureId, correlationId, /* CouldNotPersistVenture */4);
                                              throw [
                                                    DeadThread,
                                                    param[0]
                                                  ];
      ...
      return withVenture(/* None */0, partial_arg, (function (correlationId, venture) {
                    return Curry._2(Venture.Cmd[/* ProposePartner */3][/* exec */0], prospectId, venture).then((function (param) {
                                  if (typeof param === "number") {
                                    switch (param) {
                                      case 0 : 
                                          cmdError(ventureId, correlationId, /* MaxPartnersReached */0);
                                          return Promise.resolve(venture);
                                      case 1 : 
                                          cmdError(ventureId, correlationId, /* PartnerAlreadyProposed */2);
                                          return Promise.resolve(venture);
                                      case 2 : 
                                          cmdError(ventureId, correlationId, /* PartnerAlreadyExists */1);
                                          return Promise.resolve(venture);
                                      case 3 : 
                                          cmdError(ventureId, correlationId, /* CouldNotFindUserInfo */3);
                                          return Promise.resolve(venture);
