...
function handleMsg(venturesPromise, doWork, msg) {
  return venturesPromise.then((function (param) {
                ...
                if (typeof msg === "number") {
                  WorkerUtils.logMessage(logLabel, "Handling 'SessionPending'");
                  ...
                  switch (msg.tag | 0) {
                    case 0 : 
                        ...
                        WorkerUtils.logMessage(logLabel, "Handling 'SessionStarted'");
                                      ...
                                      return Belt_List.reduce(param[/* ventures */0], Promise.resolve(PrimitiveTypes.VentureId[/* makeMap */8](/* () */0)), (function (p, param) {
                                                      ...
                                                      return p.then((function (ventures) {
                                                                    return WorkerUtils.loadVenture(id).then((function (venture) {
                                                                                  ...
                                                                                  WorkerUtils.logError(logLabel, err);
                    ...
                    case 3 : 
                        WorkerUtils.logMessage(logLabel, "Handling 'VentureLoaded'");
                        return Promise.resolve(/* tuple */[
                                    storagePrefix,
                                    Belt_Map.set(ventures, msg[0], msg[1])
                                  ]);
                    case 4 : 
                        WorkerUtils.logMessage(logLabel, "Handling 'VentureCreated'");
                        return Promise.resolve(/* tuple */[
                                    storagePrefix,
                                    Belt_Map.set(ventures, msg[0], msg[1])
                                  ]);
                    case 5 : 
                        var ventureId = msg[0];
                        WorkerUtils.logMessage(logLabel, "Handling 'NewItems'");
...
self.onmessage = (function (msg) {
    ...
    intervalId[0] = id !== undefined ? id : Caml_option.some(setInterval((function (param) {
                  var param$1 = venturesPromise[0].then((function (param) {
