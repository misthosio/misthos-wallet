...
function applyInternal($staropt$star, partnerId, issuer, $$event, oldLog, param) {
  ...
  var item = match[0];
  var result = Venture__Validation.validate(Caml_option.some(partnerId), validation, item);
  var exit = 0;
...
function persist($staropt$star, param) {
  ...
  if (shouldPersist && collector.length !== 0) {
    return Blockstack$1.putFile(PrimitiveTypes.VentureId[/* toString */0](venture[/* id */1]) + "/log.json", Json.stringify(Curry._1(EventLog.encode, venture[/* log */2]))).then((function (param) {
                ...
                if (loadResult.tag) {
                  return Blockstack.getFileFromUserAndDecrypt(PrimitiveTypes.VentureId[/* toString */0](ventureId) + ("/" + (session[/* storagePrefix */3] + "/log.json")), PrimitiveTypes.UserId[/* toString */0](userId)).then((function (nullFile) {
                                    ...
                                    if (nullFile == null) {
                                      ...
                                      if (match !== undefined) {
                                        tmp = reconstruct(session, Curry._1(EventLog.decode, Caml_option.valFromOption(match)));
                                      } else {
...
function exec$2(broadcasts, broadcastFailures, incomeEvents, unlockedEvents, txConfs, venture) {
  ...
  var __x$1 = List.fold_left((function (param, $$event) {
          return apply(true, param[1], /* IncomeUnlocked */Block.__(42, [$$event]), param[0]);
        }), __x, unlockedEvents);
  var __x$2 = List.fold_left((function (param, $$event) {
          return apply(true, param[1], /* PayoutBroadcast */Block.__(34, [$$event]), param[0]);
        }), __x$1, broadcasts);
...
function exec$3(keyChain, venture) {
  ...
  if (match !== undefined) {
    return persist(undefined, apply(undefined, undefined, /* CustodianKeyChainUpdated */Block.__(37, [Event.CustodianKeyChainUpdated[/* make */0](match[/* processId */0], userId, keyChain)]), venture)).then((function (param) {
                  if (param.tag) {
                    return Promise.resolve(/* CouldNotPersist */Block.__(1, [param[0]]));
                  } else {
                    var match = param[0];
...
function exec$4(prospectId, venture) {
  ...
  if (Venture__State.isPartner(prospectId, state)) {
    ...
    return Blockstack$1.lookupProfile(PrimitiveTypes.UserId[/* toString */0](prospectId)).then((function (param) {
...
function exec$9(processId, venture) {
  ...
  var param = match !== undefined ? apply(undefined, undefined, Event.makeCustodianRemovalEndorsed(Caml_option.valFromOption(match), session[/* userId */0]), venture) : /* tuple */[
      venture,
      /* array */[]
    ];
...
function exec$10(accountIdx, venture) {
  ...
  return persist(undefined, apply(undefined, undefined, /* IncomeAddressExposed */Block.__(40, [exposeEvent]), venture)).then((function (param) {
                if (param.tag) {
                  return Promise.resolve(/* CouldNotPersist */Block.__(1, [param[0]]));
                } else {
                  var match = param[0];
