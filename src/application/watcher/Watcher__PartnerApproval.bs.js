  ...
  if (!class_tables[0]) {
    ...
    CamlinternalOO.set_methods($$class, /* array */[
          ...
          (function (self$1, param) {
              ...
              switch ($$event.tag | 0) {
                ...
                case 6 : 
                    ...
                    tmp = /* record */[
                      ...
                      /* endorsements */List.filter((function (param) {
                                return partial_arg$1(id, param);
                              }))(self$1[state][0][/* endorsements */1]),
                      /* policy */init$3[/* policy */2],
                      /* systemIssuer */init$3[/* systemIssuer */3],
                      /* creatorId */init$3[/* creatorId */4]
                    ];
                    break;
                default:
                  tmp = self$1[state][0];
              ...
              if (Caml_obj.caml_equal(env$1[0][/* data */4][/* id */0], self$1[state][0][/* creatorId */4]) && Curry._1(EventLog.length, env$1[1]) === 2) {
                self$1[result][0] = /* Some */[/* tuple */[
                    self$1[state][0][/* systemIssuer */3],
                    /* PartnerAccepted */Block.__(3, [Curry._1(Event.Partner[/* Accepted */4][/* fromProposal */0], env$1[0])])
                  ]];
