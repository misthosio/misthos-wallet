...
function make(param, param$1, log) {
  ...
  var state = Curry._3(EventLog.reduce, (function (state, param) {
          ...
          switch ($$event.tag | 0) {
            ...
            case 24 : 
                ...
                try {
                  accountKeyChains = List.assoc(keyChain[/* accountIdx */0], state[/* accountKeyChains */2]);
                }
                catch (exn){
                ...
                return /* record */[
                        ...
                        /* accountKeyChains : :: */[
                          ...
                          List.remove_assoc(keyChain[/* accountIdx */0], state[/* accountKeyChains */2])
                        ],
                        /* payoutTx */state[/* payoutTx */3],
                        /* complete */state[/* complete */4]
                      ];
  ...
  var signEvent;
  if (PrimitiveTypes.UserId[/* eq */5](param$1[/* supporterId */1], userId) && state[/* complete */4] === /* false */0) {
    ...
    signEvent = match ? /* Some */[/* tuple */[
          ...
          /* PayoutSigned */Block.__(19, [Curry._3(Event.Payout[/* Signature */5][/* make */0], payoutProcess, userId, match[0])])
        ]] : /* None */0;
  } else {
    signEvent = /* None */0;
  }
  if (!class_tables[0]) {
    ...
    CamlinternalOO.set_methods($$class, /* array */[
          ...
          processCompleted,
          (function (self$1, _) {
              return +(self$1[signPending][0] === /* false */0);
            }),
          pendingEvent,
          (function (self$1, _) {
    ...
    var env_init = function (env$1) {
      ...
      self[signPending] = [env$1[1] ? /* true */1 : /* false */0];
      self[env] = env$1[0];
      return self;
    };
