              ...
              return Utils.mapOption((function (tx) {
                            return Curry._1(Network.broadcastTransaction(env$1[2]), tx).then((function (result) {
                                          ...
                                          if (typeof result === "number") {
                                            tmp = /* tuple */[
                                              env$1[1],
                                              /* PayoutBroadcastDuplicate */Block.__(28, [Curry._1(Event.Payout[/* BroadcastDuplicate */10][/* make */0], env$1[0])])
                                            ];
                                          } else {
                                            switch (result.tag | 0) {
                                              case 0 : 
                                                  tmp = /* tuple */[
                                                    env$1[1],
                                                    /* PayoutBroadcast */Block.__(27, [Curry._2(Event.Payout[/* Broadcast */9][/* make */0], env$1[0], result[0])])
                                                  ];
                                                  break;
                                              case 1 : 
                                                  ...
                                                  tmp = /* tuple */[
                                                    env$1[1],
                                                    /* PayoutBroadcastFailed */Block.__(29, [Curry._2(Event.Payout[/* BroadcastFailed */11][/* make */0], env$1[0], errorMessage)])
                                                  ];
                                                  break;
                                              case 2 : 
                                                  tmp = /* tuple */[
                                                    env$1[1],
                                                    /* PayoutBroadcastFailed */Block.__(29, [Curry._2(Event.Payout[/* BroadcastFailed */11][/* make */0], env$1[0], "Fetch error")])
                                                  ];
                                                  break;
