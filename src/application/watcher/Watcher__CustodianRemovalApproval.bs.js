    ...
    CamlinternalOO.set_methods($$class, /* array */[
          ...
          (function (self$1, param) {
                ...
                case 19 : 
                    ...
                    if (PrimitiveTypes.ProcessId[/* eq */5]($$event$1[/* processId */0], env$1[0][/* processId */0])) {
                      ...
                      tmp = /* record */[
                        ...
                        /* endorsements */Belt_Set.add(self$1[state][0][/* endorsements */2], $$event$1[/* supporterId */1]),
              ...
              if (self$1[completed][0] === false) {
                var tmp$2 = false;
                if (self$1[state][0][/* dependencyMet */0] === true) {
              ...
              if (tmp$1) {
                self$1[result][0] = /* Some */[/* tuple */[
                    ...
                    /* CustodianRemovalAccepted */Block.__(20, [Curry._1(Event.Custodian[/* Removal */8][/* Accepted */6][/* fromProposal */0], env$1[0])])
                  ]];
                return /* () */0;
              } else {
                return 0;
