          ...
          (function (self$1, param) {
              ...
              switch ($$event.tag | 0) {
                ...
                case 15 : 
                    ...
                    if (PrimitiveTypes.UserId[/* eq */5](removedId, env$1[5]) && PrimitiveTypes.ProcessId[/* eq */5](Js_option.getExn(match[/* dependsOn */1]), env$1[4]) && WalletTypes.AccountIndex[/* eq */6](fromAccount, env$1[6])) {
