...
function broadcastTransaction(config, transaction) {
  ...
  return fetch("https://" + (config[/* subdomain */0] + "blockchain.info/pushtx?cors=true"), Fetch.RequestInit[/* make */0](/* Post */2, undefined, Js_primitive.some(formData), undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined)(/* () */0)).then((function (prim) {
                  return prim.text();
