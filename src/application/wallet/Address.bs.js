...
function make(coordinates, param) {
  ...
  var witnessScript = sequence !== undefined ? MultisigWithSequence.encode(nCoSigners, $$Array.of_list(List.map((function (prim) {
                    return prim.getPublicKeyBuffer();
                  }), keys)), sequence) : BitcoinjsLib.script.multisig.output.encode(nCoSigners, $$Array.of_list(List.map((function (prim) {
                    return prim.getPublicKeyBuffer();
                  }), keys)));
