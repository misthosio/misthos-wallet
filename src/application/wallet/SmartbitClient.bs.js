...
function broadcastTransaction(config, transaction) {
  ...
  return fetch("https://" + (config[/* subdomain */0] + ".smartbit.com.au/v1/blockchain/pushtx"), Fetch.RequestInit[/* make */0](/* Post */2, undefined, Js_primitive.some("{\"hex\":\"" + (String(txHex) + "\"}")), undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined)(/* () */0)).then((function (prim) {
                    return prim.json();
                  })).then((function (res) {
