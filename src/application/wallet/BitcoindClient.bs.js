...
function rpcCall(config, jsonRPC) {
  return fetch(config[/* bitcoindUrl */0], Fetch.RequestInit[/* make */0](/* Post */2, Js_primitive.some(makeAuthHeaders(config)), Js_primitive.some(jsonRPC), undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined)(/* () */0)).then((function (prim) {
                return prim.json();
              }));
}
