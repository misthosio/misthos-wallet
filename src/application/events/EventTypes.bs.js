...
function makeProposal(name) {
  return (function (Data) {
      var make = function ($staropt$star, $staropt$star$1, eligibleWhenProposing, proposerId, policy, data) {
        var dependsOnProposals = $staropt$star !== undefined ? Caml_option.valFromOption($staropt$star) : PrimitiveTypes.ProcessId[/* emptySet */9];
        var dependsOnCompletions = $staropt$star$1 !== undefined ? Caml_option.valFromOption($staropt$star$1) : PrimitiveTypes.ProcessId[/* emptySet */9];
        return /* record */[
