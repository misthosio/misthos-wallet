...
function makeProposal(name) {
  return (function (Data) {
      var make = function ($staropt$star, $staropt$star$1, eligibleWhenProposing, supporterId, policy, data) {
        var dependsOnProposals = $staropt$star ? $staropt$star[0] : PrimitiveTypes.ProcessId[/* emptySet */9];
        var dependsOnCompletions = $staropt$star$1 ? $staropt$star$1[0] : PrimitiveTypes.ProcessId[/* emptySet */9];
        return /* record */[
