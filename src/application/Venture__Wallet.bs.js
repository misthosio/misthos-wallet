...
function getExposedAddresses($staropt$star, param) {
  ...
  var includeChangeAddresses = $staropt$star ? $staropt$star[0] : /* false */0;
...
function apply($$event, state) {
  switch ($$event.tag | 0) {
    case 0 : 
        ...
        newrecord[/* ventureId */0] = match[/* ventureId */0];
        newrecord[/* network */1] = match[/* network */6];
        newrecord[/* payoutPolicy */2] = match[/* metaPolicy */4];
        return newrecord;
    case 9 : 
        var data = $$event[0][/* data */2];
        var newrecord$1 = state.slice();
        newrecord$1[/* accountKeyChains */3] = /* :: */[
          /* tuple */[
            data[/* accountIdx */0],
            /* [] */0
          ],
        ...
        newrecord$1[/* exposedCoordinates */6] = /* :: */[
          /* tuple */[
            data[/* accountIdx */0],
            /* [] */0
          ],
    ...
    case 20 : 
        ...
        newrecord$2[/* reservedInputs */7] = List.filter((function (input) {
                  return +(List.exists((function (i) {
                                  if (input[/* txId */0] === i[/* txId */0]) {
                                    ...
                                    return /* false */0;
                                      ...
                                      return prim[1];
                                    }), payoutTx[/* usedInputs */1])) === /* false */0);
                }))(state[/* reservedInputs */7]);
        newrecord$2[/* balance */10] = /* :: */[
          /* tuple */[
            accountIdx,
            /* record */[
    ...
    case 22 : 
        ...
        newrecord$3[/* reservedInputs */7] = List.filter((function (input) {
                  return +(List.exists((function (i) {
                                  if (input[/* txId */0] === i[/* txId */0]) {
                                    return +(input[/* txOutputN */1] === i[/* txOutputN */1]);
                                  } else {
                                    return /* false */0;
                                      ...
                                      return prim[1];
                                    }), payoutTx$1[/* usedInputs */1])) === /* false */0);
                }))(state[/* reservedInputs */7]);
        newrecord$3[/* balance */10] = /* :: */[
          /* tuple */[
            accountIdx$1,
            /* record */[
    ...
    case 24 : 
        ...
        newrecord$4[/* accountKeyChains */3] = /* :: */[
          /* tuple */[
        ...
        newrecord$4[/* nextChangeCoordinates */5] = /* :: */[
          /* tuple */[
            keyChain[/* accountIdx */0],
    ...
    case 25 : 
        ...
        newrecord$5[/* exposedCoordinates */6] = /* :: */[
          /* tuple */[
            accountIdx$2,
            /* :: */[
              /* tuple */[
    ...
    case 26 : 
        ...
        newrecord$6[/* knownIncomeTxIds */9] = /* :: */[
          match$5[/* txId */1],
          state[/* knownIncomeTxIds */9]
        ];
        newrecord$6[/* balance */10] = /* :: */[
          /* tuple */[
            accountIdx$3,
            /* record */[
...
function preparePayoutTx(param, accountIdx, destinations, satsPerByte, param$1) {
  ...
  return Curry._2(Network.transactionInputs(network), List.map((function (prim) {
                      return prim[0];
