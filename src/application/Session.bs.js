...
function signIn($staropt$star, _) {
  var environment = $staropt$star ? $staropt$star[0] : Environment.$$default;
  Blockstack.signUserOut();
  Blockstack.redirectToSignInWithAuthRequest(Blockstack.makeAuthRequest(Blockstack.generateAndStoreTransitKey(), Curry._1(environment[/* redirectURI */0], /* () */0), Curry._1(environment[/* manifestURI */1], /* () */0), /* array */[
            "store_write",
            "publish_data"
