...
ReactDOMRe.renderToElementWithId(ReasonReact.element(undefined, undefined, JssProvider.make(/* array */[ReasonReact.element(undefined, undefined, SessionStore.make((function (session, updateSession) {
                          return ReasonReact.element(undefined, undefined, MaterialUi_MuiThemeProvider.make(undefined, undefined, /* `ObjectGeneric */[
                                          -317959944,
                                          theme
                                        ], /* array */[ReasonReact.element(undefined, undefined, MaterialUi_CssBaseline.make(/* array */[ReasonReact.element(undefined, undefined, App.make(session, updateSession, /* array */[]))]))]));
                        })))])), "root");
