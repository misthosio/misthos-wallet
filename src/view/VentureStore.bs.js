...
function handler(send, msg) {
  ...
  if (match === "tab-sync") {
    try {
      return Curry._1(send, /* TabSync */Block.__(1, [VentureWorkerMessage.decodeOutgoing(Json.parseOrRaise(Js_option.getExn(Caml_option.nullable_to_opt(msg.newValue))))]));
    }
    catch (exn){
      return /* () */0;
    }
