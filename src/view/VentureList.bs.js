  ...
  return /* record */[
          ...
          /* render */(function () {
              ...
              var breakingNotification = breakingChange !== undefined && breakingChange ? ReasonReact.element(undefined, undefined, MTypography.make(/* Body2 */-904051920, Css.style(/* :: */[
                              ...
                              /* [] */0
                            ]), true, undefined, undefined, /* array */[ViewCommon.text("In preparation for our mainnet launch it has been necessary to make a breaking change. As a result your testnet ventures are no longer accessible. We will garuantee backwards compatibility following our public release on mainnet.")])) : null;
              var ventureList;
                              ...
                              return ReasonReact.element(ids, undefined, MaterialUi_ListItem.make(true, undefined, /* `String */[
                                              ...
                                              ids
                                                ...
                                                return Router.clickToRoute(partial_arg, param);
                                                                      ...
                                                                      match ? linkSelected : ""
                                                                    )), undefined, undefined, undefined, /* array */[ViewCommon.text(param[/* name */1])]))), undefined, undefined, undefined, undefined, undefined, /* array */[]))]));
                            }), ventures$1)) : ReasonReact.element(undefined, undefined, MTypography.make(/* Body2 */-904051920, undefined, undefined, undefined, undefined, /* array */[ViewCommon.text("You are not part of any Ventures yet. Create a new Venture, or join an existing Venture if you have an invite link from a Partner.")]));
              } else {
