...
function make(selected, index, _children) {
  return /* record */[
          ...
          /* render */(function (_self) {
              ...
              if (ventures !== undefined) {
                ...
                ventureList = ventures$1 ? $$Array.of_list(List.map((function (param) {
                              ...
                              var match = Caml_obj.caml_equal(Caml_option.some(id), selected);
                              return ReasonReact.element(ids, undefined, MaterialUi_ListItem.make(true, undefined, /* `String */[
                                              ...
                                              }), undefined, undefined, /* array */[ReasonReact.element(undefined, undefined, MaterialUi_ListItemText.make(undefined, undefined, undefined, Caml_option.some(ReasonReact.element(undefined, undefined, MTypography.make(/* Title */594052472, link + (" " + (
                                                                      match ? linkSelected : ""
