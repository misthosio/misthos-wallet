...
function make(variant, $staropt$star, $staropt$star$1, $staropt$star$2, component, children) {
  ...
  return /* record */[
          ...
          /* render */(function () {
              ...
              return ReasonReact.element(undefined, undefined, MaterialUi_Typography.make(undefined, style + (" " + className), undefined, component, gutterBottom, undefined, undefined, undefined, variant, undefined, undefined, /* array */[children]));
            }),
