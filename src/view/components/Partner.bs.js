...
function make(partnerId, name, button, status, onClick, $staropt$star, _) {
  ...
  return /* record */[
          ...
          /* render */(function () {
              ...
              var tmp;
              var exit = 0;
              if (button !== undefined || status !== undefined || ex) {
                exit = 1;
              } else {
                tmp = null;
              }
              if (exit === 1) {
                tmp = ex ? ReasonReact.element(undefined, undefined, MTypography.make(/* Body2 */-904051920, exPartnerStatus, undefined, undefined, undefined, /* array */[ViewCommon.text("EX-PARTNER")])) : (
                    button !== undefined ? ReasonReact.element(undefined, undefined, MaterialUi_ListItemSecondaryAction.make(undefined, undefined, undefined, /* array */[Js_primitive.valFromOption(button)])) : ReasonReact.element(undefined, undefined, MaterialUi_ListItemSecondaryAction.make(undefined, undefined, undefined, /* array */[Js_primitive.valFromOption(status)]))
                  );
              }
              return ReasonReact.element(undefined, undefined, MaterialUi_ListItem.make(undefined, undefined, undefined, undefined, undefined, undefined, undefined, true, undefined, undefined, undefined, undefined, onClick, /* :: */[
