...
function message(variant, message$1) {
  ...
  return ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Body2 */-904051920, /* Some */[Css.style(/* :: */[
                        Css.color(color),
                        /* [] */0
                      ])], /* None */0, /* None */0, /* array */[ViewCommon.text(message$1)]));
}
              ...
              if (typeof cmdStatus === "number") {
                ...
                switch (cmdStatus.tag | 0) {
                  case 0 : 
                      ...
                      return /* array */[
                              ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Body2 */-904051920, /* None */0, /* None */0, /* None */0, /* array */[ViewCommon.text(tmp)])),
