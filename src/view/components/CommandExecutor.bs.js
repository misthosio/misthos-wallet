...
function message(variant, message$1) {
  ...
  return ReasonReact.element(undefined, undefined, MTypography.make(/* Body2 */-904051920, Css.style(/* :: */[
                      Css.color(color),
                      /* [] */0
                    ]), undefined, undefined, undefined, /* array */[ViewCommon.text(message$1)]));
}
              ...
              if (typeof cmdStatus === "number") {
                ...
                switch (cmdStatus.tag | 0) {
                  case 0 : 
                      ...
                      return /* array */[
                              ReasonReact.element(undefined, undefined, MTypography.make(/* Body2 */-904051920, undefined, undefined, undefined, undefined, /* array */[ViewCommon.text(tmp)])),
