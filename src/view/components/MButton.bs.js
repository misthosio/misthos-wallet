...
function make(color, onClick, size, $staropt$star, $staropt$star$1, children) {
  ...
  return /* record */[
          ...
          /* render */(function () {
              return ReasonReact.element(/* None */0, /* None */0, MaterialUi.Button[/* make */7](/* Some */[button(fullWidth, variant)], color, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, size, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, onClick, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* array */[children]));
            }),
