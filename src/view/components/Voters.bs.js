  ...
  return /* record */[
          ...
          /* render */(function () {
              var voters$1 = Belt_List.toArray(Belt_List.map(voters, (function (param) {
                          ...
                          var label = match$1[0];
                          return ReasonReact.element(/* None */0, /* None */0, Partner.make(userId, /* None */0, /* None */0, /* Some */[Utils.mapOption((function (status) {
                                                  return ReasonReact.element(/* None */0, /* None */0, StatusChip.make(status, label, /* array */[]));
                                                }), match$1[1])], /* None */0, /* Some */[match$1[2]], /* array */[]));
                        })));
              return /* array */[
                      ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Title */594052472, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* array */[ViewCommon.text("Endorsement Status")])),
