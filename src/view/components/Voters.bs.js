  ...
  return /* record */[
          ...
          /* render */(function () {
              var voters$1 = $$Array.of_list(List.map((function (param) {
                          ...
                          return ReasonReact.element(/* None */0, /* None */0, Partner.make(param[/* userId */0], /* None */0, /* None */0, /* Some */[ReasonReact.element(/* None */0, /* None */0, StatusChip.make(match[1], match[0], /* array */[]))], /* None */0, /* None */0, /* array */[]));
                        }), voters));
              return /* array */[
