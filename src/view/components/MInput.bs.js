...
function make(placeholder, value, onChange, autoFocus, fullWidth, endAdornment, $staropt$star, _) {
  ...
  return /* record */[
          ...
          /* render */(function () {
              return ReasonReact.element(/* None */0, /* None */0, MaterialUi.Input[/* make */3](/* None */0, autoFocus, /* Some */[margin(ensuring ? 4 : 3, 0)], /* None */0, /* None */0, /* None */0, endAdornment, /* None */0, fullWidth, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, onChange, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, placeholder, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, value, /* None */0, /* array */[]));
            }),
