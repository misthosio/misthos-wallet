          ...
          /* render */(function (param) {
              ...
              if (exit === 1) {
                return ReasonReact.element(/* None */0, /* None */0, Body2.make(/* Some */[/* :: */[
                                  "Create a Venture",
                                  /* [] */0
                                ]], React.createElement("div", undefined, ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Body2 */-904051920, /* array */[Utils.text("\n                 Set up a new Venture with yourself as the initial Partner.\n                 You can add and remove Partners once the Venture is created.\n                 But first, let’s start with a name.\n                ")])), ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Title */594052472, /* array */[Utils.text("Venture Name")])), ReasonReact.element(/* None */0, /* None */0, MInput.make(/* Some */["Enter a Venture Name"], /* Some */[/* `String */[
                                              -976970511,
                                              ...
                                              })], /* Some */[true], /* array */[Utils.text("create venture")]))), React.createElement("div", {
                                    className: infoBox
                                  }, ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Title */594052472, /* array */[Utils.text("What can you do with a venture?")])), ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Body2 */-904051920, /* array */[Utils.text("\n                 • Your Venture can receive money from different sources, such as customers, clients, and investors\n                ")])), ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Body2 */-904051920, /* array */[Utils.text("\n                 • Every Partner of the Venture has full transparency of income and payouts\n                ")])), ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Body2 */-904051920, /* array */[Utils.text("\n                 • The team decides the Policies by which payouts take place\n                ")]))), /* array */[]));
              }
