              ...
              if (exit === 1) {
                return ReasonReact.element(/* None */0, /* None */0, Body2.make(/* Some */[/* :: */[
                                  ...
                                  /* [] */0
                                    ...
                                    className: infoBox
                                  }, ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Title */594052472, /* None */0, /* array */[Utils.text("What can you do with a venture?")])), ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Body2 */-904051920, /* None */0, /* array */[Utils.text("\n                 • Your Venture can receive money from different sources, such as customers, clients, and investors\n                ")])), ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Body2 */-904051920, /* None */0, /* array */[Utils.text("\n                 • Every Partner of the Venture has full transparency of income and payouts\n                ")])), ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Body2 */-904051920, /* None */0, /* array */[Utils.text("\n                 • The team decides the Policies by which payouts take place\n                ")]))), /* array */[]));
              }
