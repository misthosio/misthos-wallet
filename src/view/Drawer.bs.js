          ...
          /* render */(function () {
              ...
              return ReasonReact.element(/* None */0, /* None */0, Grid.make(/* Some */[ViewCommon.text("My Ventures")], /* None */0, /* None */0, /* None */0, /* Some */[React.createElement("div", {
                                    className: ScrollList.containerStyles
                                      ...
                                      }), ReasonReact.element(/* None */0, /* None */0, MButton.make(/* Some */[/* Inherit */-72987685], /* None */0, /* None */0, /* None */0, /* Some */[/* Flat */0], /* Some */[alignStart], /* Some */[true], /* None */0, /* Some */[environment[/* webDomain */3] + "/faq"], /* Some */[true], /* array */["frequently asked questions"])), ReasonReact.element(/* None */0, /* None */0, MButton.make(/* Some */[/* Inherit */-72987685], /* None */0, /* None */0, /* None */0, /* Some */[/* Flat */0], /* Some */[alignStart], /* Some */[false], /* None */0, /* Some */["mailto:contact@misthos.io"], /* None */0, /* array */["Contact us"])), ReasonReact.element(/* None */0, /* None */0, MButton.make(/* Some */[/* Inherit */-72987685], /* Some */[onSignOut], /* None */0, /* None */0, /* Some */[/* Flat */0], /* Some */[alignStart], /* Some */[false], /* Some */[true], /* None */0, /* None */0, /* array */["Sign Out"])))], /* None */0, /* None */0, /* None */0, /* array */[]));
            }),
