  ...
  var renderExpandedInfo = function (details) {
    ...
    return React.createElement("div", {
                className: detailsGrid
                                  ...
                                  }))]))), React.createElement("div", undefined, ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Title */594052472, /* None */0, /* Some */[true], /* None */0, /* None */0, /* array */[ViewCommon.text("OVERVIEW")])), ReasonReact.element(/* None */0, /* None */0, MaterialUi_List.make(/* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* array */[Belt_List.toArray(Belt_List.concat(Belt_List.concat(renderTx(details[/* addressStatus */4], details[/* unspentIncome */5], txLabel), renderTx(details[/* addressStatus */4], details[/* spentIncome */6], txLabel + " - transferred")), param ? /* :: */[
