...
function unusedInputs(param) {
  ...
  console.log("unused", Belt_Set.toArray(unused));
  console.log("reserved", Belt_Set.toArray(Belt_Set.mergeMany(Network.inputSet(/* () */0), Belt_Map.keysToArray(reserved))));
  return Belt_Set.diff(unused, Belt_Set.mergeMany(Network.inputSet(/* () */0), Belt_Map.keysToArray(reserved)));
}
