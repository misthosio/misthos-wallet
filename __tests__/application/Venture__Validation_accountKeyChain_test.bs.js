...
describe(" AccountKeyChainIdentified", (function () {
        Fixtures.withCached(/* None */0, "AccountKeyChainIdentified", "when everything is fine", (function () {
                ...
                var user1 = match[0];
                return Generators.Log[/* withCustodianKeyChain */37](/* None */0, /* None */0, user1, Generators.Log[/* withCustodian */32](user1, /* :: */[
                                user1,
                                /* [] */0
                              ], Generators.Log[/* withAccount */26](user1, Generators.Log[/* withFirstPartner */18](user1)(Generators.Log[/* createVenture */11](user1)))));
              }), (function (_, log) {
                return ValidationHelpers.testValidationResult(ValidationHelpers.constructState(log), Generators.Log[/* lastItem */4](Generators.Log[/* withAccountKeyChainIdentified */38](log)), /* Ok */0);
              }));
        Fixtures.withCached(/* None */0, "AccountKeyChainIdentified", "when the account doesn't exist", (function () {
                ...
                var identified = Event.getAccountKeyChainIdentifiedExn(Generators.Log[/* lastEvent */5](Generators.Log[/* withAccountKeyChainIdentified */38](log)));
        ...
        Fixtures.withCached(/* None */0, "AccountKeyChainIdentified", "with an old custodian", (function () {
                ...
                var user2 = match[1];
                var user1 = match[0];
                return Generators.Log[/* withCustodianKeyChain */37](/* Some */[1], /* None */0, user1, Generators.Log[/* withPartnerRemoved */22](user2, /* :: */[
                                user1,
                                /* [] */0
                              ], Generators.Log[/* withCustodianRemoved */36](user2, /* :: */[
                                    user1,
                                    /* [] */0
                                  ], Generators.Log[/* withAccountKeyChainIdentified */38](Generators.Log[/* withCustodianKeyChain */37](/* None */0, /* None */0, user2, Generators.Log[/* withCustodian */32](user2, /* :: */[
                                                user1,
                                                /* :: */[
                                                  user2,
                                                  /* [] */0
                                                    ...
                                                    user1,
                                                    /* [] */0
                                                  ], Generators.Log[/* withCustodianKeyChain */37](/* None */0, /* None */0, user1, Generators.Log[/* withCustodian */32](user1, /* :: */[
                                                            user1,
                                                            /* [] */0
                                                          ], Generators.Log[/* withAccount */26](user1, Generators.Log[/* withFirstPartner */18](user1)(Generators.Log[/* createVenture */11](user1))))))))))));
...
describe("AccountKeyChainActivated", (function () {
        Fixtures.withCached(/* None */0, "AccountKeyChainActivated", "when everything is fine", (function () {
                ...
                var match = Generators.twoUserSessionsFromArray(sessions);
                var user1 = match[0];
                return Generators.Log[/* withAccountKeyChainIdentified */38](Generators.Log[/* withCustodianKeyChain */37](/* None */0, /* None */0, user1, Generators.Log[/* withCustodian */32](user1, /* :: */[
                                    user1,
                                    /* [] */0
                                  ], Generators.Log[/* withAccount */26](user1, Generators.Log[/* withFirstPartner */18](user1)(Generators.Log[/* createVenture */11](user1))))));
              }), (function (sessions, log) {
                var match = Generators.twoUserSessionsFromArray(sessions);
                return ValidationHelpers.testValidationResult(ValidationHelpers.constructState(log), Generators.Log[/* lastItem */4](Generators.Log[/* withAccountKeyChainActivated */39](/* None */0, match[0], log)), /* Ok */0);
              }));
        Fixtures.withCached(/* None */0, "AccountKeyChainActivated", "after a partner removal", (function () {
                ...
                return Generators.Log[/* withPartnerRemoved */22](user2, /* :: */[
                            user1,
                            /* [] */0
                          ], Generators.Log[/* withAccountKeyChainActivated */39](/* None */0, user1, Generators.Log[/* withAccountKeyChainActivated */39](/* None */0, user2, Generators.Log[/* withAccountKeyChainIdentified */38](Generators.Log[/* withCustodianKeyChain */37](/* None */0, /* None */0, user2, Generators.Log[/* withCustodian */32](user2, /* :: */[
                                                user1,
                                                /* :: */[
                                                  user2,
                                                  /* [] */0
                ...
                var match = Generators.twoUserSessionsFromArray(sessions);
                return ValidationHelpers.testValidationResult(ValidationHelpers.constructState(log), Generators.Log[/* lastItem */4](Generators.Log[/* withAccountKeyChainActivated */39](/* Some */[1], match[0], log)), /* Ok */0);
              }));
        Fixtures.withCached(/* None */0, "AccountKeyChainActivated", "when the account doesn't exist", (function () {
                ...
                var match = Generators.twoUserSessionsFromArray(sessions);
                var user1 = match[0];
                var activated = Event.getAccountKeyChainActivatedExn(Generators.Log[/* lastEvent */5](Generators.Log[/* withAccountKeyChainActivated */39](/* None */0, user1, log)));
                return ValidationHelpers.testDataValidation((function (param, param$1) {
        ...
        Fixtures.withCached(/* None */0, "AccountKeyChainActivated", "when the issuer doesn't match", (function () {
                ...
                return Generators.Log[/* withPartner */17](match[1], /* :: */[
                            user1,
                            /* [] */0
                          ], Generators.Log[/* withAccountKeyChainIdentified */38](Generators.Log[/* withCustodianKeyChain */37](/* None */0, /* None */0, user1, Generators.Log[/* withCustodian */32](user1, /* :: */[
                                        user1,
                                        /* [] */0
                                      ], Generators.Log[/* withAccount */26](user1, Generators.Log[/* withFirstPartner */18](user1)(Generators.Log[/* createVenture */11](user1)))))));
              }), (function (sessions, log) {
                var match = Generators.twoUserSessionsFromArray(sessions);
                var user2 = match[1];
                var activated = Event.getAccountKeyChainActivatedExn(Generators.Log[/* lastEvent */5](Generators.Log[/* withAccountKeyChainActivated */39](/* None */0, match[0], log)));
                return ValidationHelpers.testDataValidation((function (param, param$1) {
        ...
        Fixtures.withCached(/* None */0, "AccountKeyChainActivated", "when the issuer is not a custodian", (function () {
                ...
                var match = Generators.twoUserSessionsFromArray(sessions);
                var user2 = match[1];
                var activated = Event.getAccountKeyChainActivatedExn(Generators.Log[/* lastEvent */5](Generators.Log[/* withAccountKeyChainActivated */39](/* None */0, user2, log)));
                return ValidationHelpers.testDataValidation((function (param, param$1) {
                              return ValidationHelpers.withIssuer(user2, Venture__Validation.validateAccountKeyChainActivated, param, param$1);
