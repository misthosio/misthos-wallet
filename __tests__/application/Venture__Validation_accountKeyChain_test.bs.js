...
describe(" AccountKeyChainIdentified", (function () {
        describe("when everything is fine", (function () {
                ...
                var user1 = match[0];
                var log = Generators.Log[/* withCustodianKeyChain */38](/* None */0, /* None */0, /* None */0, user1, Generators.Log[/* withCustodian */33](user1, /* :: */[
                          user1,
                          /* [] */0
        ...
        describe("when the account doesn't exist", (function () {
                ...
                return ValidationHelpers.testDataValidation((function (param, param$1) {
                            ...
                            }), ValidationHelpers.constructState(/* None */0, log), /* record */[/* keyChain : record */[
        ...
        describe("with an old custodian", (function () {
                ...
                var user2 = match[1];
                var user1 = match[0];
                var eta = Generators.Log[/* withCustodianKeyChain */38](/* None */0, /* None */0, /* None */0, user2, Generators.Log[/* withCustodian */33](user2, /* :: */[
                          user1,
                          /* :: */[
                            user2,
                            /* [] */0
                ...
                var log = Generators.Log[/* withCustodianKeyChain */38](/* Some */[1], /* None */0, /* None */0, user1, Generators.Log[/* withPartnerRemoved */23](user2, /* :: */[
                          user1,
                          /* [] */0
                ...
                return ValidationHelpers.testDataValidation((function (param, param$1) {
                              return ValidationHelpers.withSystemIssuer(Venture__Validation.validateAccountKeyChainIdentified, param, param$1);
                                  ...
                                  /* tuple */[
                                    user1[/* userId */0],
                                    Generators.custodianKeyChain(/* None */0, /* None */0, Generators.Log[/* ventureId */2](log), 1, user1)
                                  ],
                                  /* :: */[
                                    /* tuple */[
                                      user2[/* userId */0],
                                      Generators.custodianKeyChain(/* None */0, /* None */0, Generators.Log[/* ventureId */2](log), 0, user2)
                                    ],
                                    /* [] */0
                                  ]
        ...
        describe("when a CustodianKeyChain is unknown", (function () {
                ...
                return ValidationHelpers.testDataValidation((function (param, param$1) {
                              return ValidationHelpers.withSystemIssuer(Venture__Validation.validateAccountKeyChainIdentified, param, param$1);
                                  ...
                                  /* tuple */[
                                    user1[/* userId */0],
                                    Generators.custodianKeyChain(/* None */0, /* None */0, PrimitiveTypes.VentureId[/* make */10](/* () */0), 1, user1)
                                  ],
                                  /* [] */0
...
describe("AccountKeyChainActivated", (function () {
        describe("when everything is fine", (function () {
                ...
                var log = Generators.Log[/* withAccountKeyChainIdentified */39](/* None */0, eta);
                return ValidationHelpers.testValidationResult(/* None */0, ValidationHelpers.constructState(/* None */0, log), Generators.Log[/* lastItem */4](Generators.Log[/* withAccountKeyChainActivated */40](/* None */0, user1, log)), /* Ok */0);
              }));
        describe("after a partner removal", (function () {
                ...
                return ValidationHelpers.testValidationResult(/* None */0, ValidationHelpers.constructState(/* None */0, log), Generators.Log[/* lastItem */4](Generators.Log[/* withAccountKeyChainActivated */40](/* Some */[1], user1, log)), /* Ok */0);
              }));
        describe("when the account doesn't exist", (function () {
                var match = Generators.twoUserSessions(/* () */0);
                var user1 = match[0];
