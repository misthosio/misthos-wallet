...
describe("Any rejection type", (function () {
        ...
        describe("when the rejector is not a partner", (function () {
                ...
                return ValidationHelpers.testValidationResult(/* None */0, ValidationHelpers.constructState(/* None */0, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerRejected */14](/* None */0, user3, proposal)(log)), /* InvalidIssuer */2);
              }));
        describe("when the rejector is not the signer", (function () {
                ...
                var proposal = Event.getPartnerProposedExn(Generators.Log[/* lastEvent */5](log));
                return ValidationHelpers.testValidationResult(/* None */0, ValidationHelpers.constructState(/* None */0, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerRejected */14](/* Some */[user1[/* issuerKeyPair */2]], user2, proposal)(log)), /* InvalidIssuer */2);
              }));
        describe("when the rejection has already been submitted", (function () {
                ...
                var user2 = match[1];
                var user1 = match[0];
                var eta = Generators.Log[/* withPartner */17](/* None */0, match[2], /* :: */[
                      user1,
                      /* :: */[
                        user2,
                        /* [] */0
        ...
        describe("when the rejection is fine", (function () {
                ...
                var proposal = Event.getPartnerProposedExn(Generators.Log[/* lastEvent */5](log));
                return ValidationHelpers.testValidationResult(/* None */0, ValidationHelpers.constructState(/* None */0, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerRejected */14](/* None */0, user2, proposal)(log)), /* Ok */0);
              }));
        return /* () */0;
      }));
...
describe("Any endorsement type", (function () {
        ...
        describe("when the supporter is not a partner", (function () {
                ...
                var proposal = Event.getPartnerProposedExn(Generators.Log[/* lastEvent */5](log));
                return ValidationHelpers.testValidationResult(/* None */0, ValidationHelpers.constructState(/* None */0, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerEndorsed */13](/* None */0, user3, proposal)(log)), /* InvalidIssuer */2);
              }));
        describe("when the supporter is not the signer", (function () {
                var match = Generators.threeUserSessions(/* () */0);
                var user3 = match[2];
                ...
                var proposal = Event.getPartnerProposedExn(Generators.Log[/* lastEvent */5](log));
                return ValidationHelpers.testValidationResult(/* None */0, ValidationHelpers.constructState(/* None */0, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerEndorsed */13](/* Some */[user1[/* issuerKeyPair */2]], user2, proposal)(log)), /* InvalidIssuer */2);
              }));
        ...
        describe("when the endorsement is fine", (function () {
                ...
                var proposal = Event.getPartnerProposedExn(Generators.Log[/* lastEvent */5](log));
                return ValidationHelpers.testValidationResult(/* None */0, ValidationHelpers.constructState(/* None */0, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerEndorsed */13](/* None */0, user2, proposal)(log)), /* Ok */0);
              }));
        return /* () */0;
      }));
