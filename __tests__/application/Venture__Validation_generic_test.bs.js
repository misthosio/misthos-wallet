...
describe("Any proposal type", (function () {
        Fixtures.withCached(undefined, undefined, "Any proposal type", "when submitting the identical proposal twice", (function () {
        ...
        Fixtures.withCached(undefined, undefined, "Any proposal type", "when the supporter is a non-partner", (function () {
        ...
        Fixtures.withCached(undefined, undefined, "Any proposal type", "when the supporter is not the signer", (function () {
                return Generators.withUserSessions(3);
              }), (function (sessions) {
                var match = Generators.threeUserSessionsFromArray(sessions);
                var user1 = match[0];
                ...
                var user2 = match[1];
                var func = Generators.Log[/* withPartnerProposed */12];
                var arg = Js_primitive.some(match[0][/* issuerKeyPair */2]);
        ...
        return Fixtures.withCached(undefined, undefined, "Any proposal type", "when the same proposal was already made by another partner", (function () {
                      return Generators.withUserSessions(3);
                    }), (function (sessions) {
                      var match = Generators.threeUserSessionsFromArray(sessions);
                      var user3 = match[2];
...
describe("Any rejection type", (function () {
        Fixtures.withCached(undefined, undefined, "Any rejection type", "when the process is unknown", (function () {
                return Generators.withUserSessions(3);
              }), (function (sessions) {
                var match = Generators.threeUserSessionsFromArray(sessions);
                var user3 = match[2];
        ...
        Fixtures.withCached(undefined, undefined, "Any rejection type", "when the rejector is not a partner", (function () {
                return Generators.withUserSessions(3);
              }), (function (sessions) {
                var match = Generators.threeUserSessionsFromArray(sessions);
                var user3 = match[2];
                ...
                return ValidationHelpers.testValidationResult(undefined, ValidationHelpers.constructState(undefined, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerRejected */14](undefined, match[2], proposal)(log)), /* InvalidIssuer */2);
              }));
        Fixtures.withCached(undefined, undefined, "Any rejection type", "when the rejector is not the signer", (function () {
                return Generators.withUserSessions(3);
              }), (function (sessions) {
                var match = Generators.threeUserSessionsFromArray(sessions);
                var user3 = match[2];
                ...
                var match = Generators.threeUserSessionsFromArray(sessions);
                var proposal = Event.getPartnerProposedExn(Generators.Log[/* lastEvent */5](log));
                return ValidationHelpers.testValidationResult(undefined, ValidationHelpers.constructState(undefined, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerRejected */14](Js_primitive.some(match[0][/* issuerKeyPair */2]), match[1], proposal)(log)), /* InvalidIssuer */2);
              }));
        Fixtures.withCached(undefined, undefined, "Any rejection type", "when the rejection has already been submitted", (function () {
                ...
                return Curry._1((function (param, param$1, param$2, param$3) {
                              ...
                              })(undefined, undefined, undefined, undefined), Generators.Log[/* withPartner */17](undefined, match[2], /* :: */[
                                user1,
                                /* :: */[
                                  user2,
                                  /* [] */0
        ...
        Fixtures.withCached(undefined, undefined, "Any rejection type", "when the rejector has already endorsed", (function () {
                return Generators.withUserSessions(4);
              }), (function (sessions) {
                var match = Generators.fourUserSessionsFromArray(sessions);
                var user4 = match[3];
        ...
        return Fixtures.withCached(undefined, undefined, "Any rejection type", "when the rejection is fine", (function () {
                      return Generators.withUserSessions(3);
                    }), (function (sessions) {
                      var match = Generators.threeUserSessionsFromArray(sessions);
                      var user3 = match[2];
                      ...
                      var match = Generators.threeUserSessionsFromArray(sessions);
                      var proposal = Event.getPartnerProposedExn(Generators.Log[/* lastEvent */5](log));
                      return ValidationHelpers.testValidationResult(undefined, ValidationHelpers.constructState(undefined, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerRejected */14](undefined, match[1], proposal)(log)), /* Ok */0);
                    }));
      }));

describe("Any endorsement type", (function () {
        Fixtures.withCached(undefined, undefined, "Any endorsement type", "when the process is unknown", (function () {
                return Generators.withUserSessions(3);
              }), (function (sessions) {
                var match = Generators.threeUserSessionsFromArray(sessions);
                var user3 = match[2];
        ...
        Fixtures.withCached(undefined, undefined, "Any endorsement type", "when the supporter is not a partner", (function () {
                return Generators.withUserSessions(3);
              }), (function (sessions) {
                var match = Generators.threeUserSessionsFromArray(sessions);
                var user3 = match[2];
                ...
                var match = Generators.threeUserSessionsFromArray(sessions);
                var proposal = Event.getPartnerProposedExn(Generators.Log[/* lastEvent */5](log));
                return ValidationHelpers.testValidationResult(undefined, ValidationHelpers.constructState(undefined, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerEndorsed */13](undefined, match[2], proposal)(log)), /* InvalidIssuer */2);
              }));
        Fixtures.withCached(undefined, undefined, "Any endorsement type", "when the supporter is not the signer", (function () {
                return Generators.withUserSessions(3);
              }), (function (sessions) {
                var match = Generators.threeUserSessionsFromArray(sessions);
                var user3 = match[2];
                ...
                var match = Generators.threeUserSessionsFromArray(sessions);
                var proposal = Event.getPartnerProposedExn(Generators.Log[/* lastEvent */5](log));
                return ValidationHelpers.testValidationResult(undefined, ValidationHelpers.constructState(undefined, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerEndorsed */13](Js_primitive.some(match[0][/* issuerKeyPair */2]), match[1], proposal)(log)), /* InvalidIssuer */2);
              }));
        Fixtures.withCached(undefined, undefined, "Any endorsement type", "when the endorsement has already been submitted", (function () {
                return Generators.withUserSessions(4);
              }), (function (sessions) {
                var match = Generators.fourUserSessionsFromArray(sessions);
                var user4 = match[3];
                ...
                var match = Generators.fourUserSessionsFromArray(sessions);
                var proposal = Event.getPartnerProposedExn(Generators.Log[/* lastEvent */5](log));
                var log$1 = Generators.Log[/* withPartnerEndorsed */13](undefined, match[1], proposal)(log);
                return ValidationHelpers.testValidationResult(undefined, ValidationHelpers.constructState(undefined, log$1), Generators.Log[/* lastItem */4](log$1), /* Ignore */1);
              }));
        Fixtures.withCached(undefined, undefined, "Any endorsement type", "when the supporter has already rejected", (function () {
                return Generators.withUserSessions(4);
              }), (function (sessions) {
                var match = Generators.fourUserSessionsFromArray(sessions);
                var user4 = match[3];
        ...
        return Fixtures.withCached(undefined, undefined, "Any endorsement type", "when the endorsement is fine", (function () {
                      return Generators.withUserSessions(3);
                    }), (function (sessions) {
                      var match = Generators.threeUserSessionsFromArray(sessions);
                      var user3 = match[2];
                      ...
                      var match = Generators.threeUserSessionsFromArray(sessions);
                      var proposal = Event.getPartnerProposedExn(Generators.Log[/* lastEvent */5](log));
                      return ValidationHelpers.testValidationResult(undefined, ValidationHelpers.constructState(undefined, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerEndorsed */13](undefined, match[1], proposal)(log)), /* Ok */0);
                    }));
      }));

describe("Any acceptance type", (function () {
        Fixtures.withCached(undefined, undefined, "Any acceptance type", "when everything is fine", (function () {
                return Generators.withUserSessions(3);
              }), (function (sessions) {
                var match = Generators.threeUserSessionsFromArray(sessions);
                var user3 = match[2];
        ...
        Fixtures.withCached(undefined, undefined, "Any acceptance type", "New partners don't effect eligiblity", (function () {
                return Generators.withUserSessions(4);
              }), (function (sessions) {
                var match = Generators.fourUserSessionsFromArray(sessions);
                var user3 = match[2];
        ...
        Fixtures.withCached(undefined, undefined, "Any acceptance type", "when the data is wrong", (function () {
                return Generators.withUserSessions(3);
              }), (function (sessions) {
                var match = Generators.threeUserSessionsFromArray(sessions);
                var user3 = match[2];
        ...
        return Fixtures.withCached(undefined, undefined, "Any acceptance type", "when the policy is not fullfilled", (function () {
                      return Generators.withUserSessions(3);
                    }), (function (sessions) {
                      var match = Generators.threeUserSessionsFromArray(sessions);
                      var user3 = match[2];
