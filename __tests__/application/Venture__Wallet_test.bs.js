...
describe("interation", (function () {
        ...
        Jest.testPromise(/* None */0, "1 of 2 wallet", (function () {
                return Helpers.getUTXOs(Venture__Wallet.getExposedAddresses(/* Some */[/* true */1], oneKeyChainWallet[0])).then((function (utxos) {
        ...
        return Jest.testPromise(/* Some */[80000], "2 of 2 wallet", (function () {
                      return Venture__Wallet.preparePayoutTx(/* record */[
                                    ...
                                    return Helpers.getUTXOs(Venture__Wallet.getExposedAddresses(/* Some */[/* true */1], param[0])).then((function (utxos) {
