...
describe("Venture__Wallet", (function () {
        return Fixtures.withCached(undefined, undefined, "Venture__Wallet", "nextIncomeAddress", (function () {
                      return Fixtures.threeUserSessionsArray;
                    }), (function (sessions) {
                      var match = Generators.threeUserSessionsFromArray(sessions);
                      var user2 = match[1];
                      var user1 = match[0];
                      var eta = Generators.Log[/* withCustodianKeyChain */38](undefined, undefined, user2, Generators.Log[/* withCustodianKeyChain */38](undefined, undefined, user1, Generators.Log[/* withCustodian */33](user2, /* :: */[
                                    user1,
                                    /* :: */[
                                      user2,
                                      /* [] */0
                      ...
                      return Generators.Log[/* withAccountKeyChainActivated */40](undefined, user2, Generators.Log[/* withAccountKeyChainActivated */40](undefined, user1, Generators.Log[/* withAccountKeyChainIdentified */39](undefined, eta)));
                      ...
                      var eta = Generators.Log[/* withCustodianKeyChain */38](undefined, undefined, user3, Generators.Log[/* withCustodian */33](user3, /* :: */[
                                user1,
                                /* :: */[
                                  user2,
                                  /* :: */[
                      ...
                      var log$1 = Generators.Log[/* withAccountKeyChainActivated */40](undefined, user3, Generators.Log[/* withAccountKeyChainActivated */40](undefined, user2, Generators.Log[/* withAccountKeyChainActivated */40](undefined, user1, Generators.Log[/* withAccountKeyChainIdentified */39](undefined, eta))));
