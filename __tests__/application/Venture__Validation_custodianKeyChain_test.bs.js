...
describe("CustodianKeyChainUpdate", (function () {
        describe("when everything is fine", (function () {
                ...
                return ValidationHelpers.testValidationResult(ValidationHelpers.constructState(log), Generators.Log[/* lastItem */3](Generators.Log[/* withCustodianKeyChain */31](/* None */0, /* None */0, user1, log)), /* Ok */0);
              }));
        describe("when the signer doesn't match the custodianId", (function () {
                ...
                return ValidationHelpers.testValidationResult(ValidationHelpers.constructState(log), Generators.Log[/* lastItem */3](Generators.Log[/* withCustodianKeyChain */31](/* None */0, /* Some */[user2], user1, log)), /* InvalidIssuer */2);
              }));
        ...
        describe("when the custodianApprovalProcess isn't completed", (function () {
                var match = Generators.twoUserSessions(/* () */0);
                var user1 = match[0];
                var log = Generators.Log[/* withCustodianProposed */23](user1, user1, Generators.Log[/* withAccount */22](user1, Generators.Log[/* withFirstPartner */15](user1)(Generators.Log[/* createVenture */9](user1))));
        ...
        describe("when the custodian approval process is for another user", (function () {
                ...
                var log$1 = Generators.Log[/* withPartner */14](user2, /* :: */[
                      user1,
                      /* [] */0
                    ], log);
                return ValidationHelpers.testDataValidation((function (param, param$1) {
