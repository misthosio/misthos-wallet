...
describe("Watcher__CustodianKeyChain", (function () {
        Fixtures.withCached(undefined, undefined, "Watcher__CustodianKeyChain", "Will create the initial keychain", (function () {
                ...
                return WatcherHelpers.testWatcherHasEventPending("CustodianKeyChainUpdated", watcher, user1[/* issuerKeyPair */2], (function (param) {
                              if (param.tag === 37) {
                                ...
                                if (PrimitiveTypes.ProcessId[/* eq */5](match[/* custodianApprovalProcess */0], acceptance[/* processId */0]) && PrimitiveTypes.UserId[/* eq */5](match[/* custodianId */1], user1[/* userId */0])) {
                                  return keyChainEq(Generators.custodianKeyChain(undefined, Generators.Log[/* ventureId */2](log), 0, user1), match[/* keyChain */2]);
                                } else {
                                  return false;
                                }
                              } else {
        ...
        Fixtures.withCached(undefined, undefined, "Watcher__CustodianKeyChain", "Is idle when the keychain has been updated", (function () {
                return Generators.withUserSessions(2);
              }), (function (sessions) {
                var match = Generators.twoUserSessionsFromArray(sessions);
                var user1 = match[0];
                ...
                var acceptance = Event.getCustodianAcceptedExn(Generators.Log[/* lastEvent */5](log));
                var watcher = Watcher__CustodianKeyChain.make(user1, acceptance, Generators.Log[/* eventLog */6](log));
                var log$1 = Generators.Log[/* withCustodianKeyChain */38](undefined, undefined, user1, log);
        ...
        Fixtures.withCached(undefined, undefined, "Watcher__CustodianKeyChain", "Will update the keychain when a partner is removed", (function () {
                return Generators.withUserSessions(2);
              }), (function (sessions) {
                var match = Generators.twoUserSessionsFromArray(sessions);
                var user1 = match[0];
                ...
                var log$1 = Generators.Log[/* withPartnerRemoved */23](user2, /* :: */[
                      ...
                      /* [] */0
                          ...
                          user1,
                          /* [] */0
                        ], Generators.Log[/* withCustodianKeyChain */38](undefined, undefined, user1, log)));
                var watcher = Watcher__CustodianKeyChain.make(user1, acceptance, Generators.Log[/* eventLog */6](log$1));
                return WatcherHelpers.testWatcherHasEventPending("CustodianKeyChainUpdated", watcher, user1[/* issuerKeyPair */2], (function (param) {
                              if (param.tag === 37) {
                                var match = param[0];
                                if (PrimitiveTypes.ProcessId[/* eq */5](match[/* custodianApprovalProcess */0], acceptance[/* processId */0]) && PrimitiveTypes.UserId[/* eq */5](match[/* custodianId */1], user1[/* userId */0])) {
                                  return keyChainEq(Generators.custodianKeyChain(undefined, Generators.Log[/* ventureId */2](log$1), 1, user1), match[/* keyChain */2]);
                                } else {
                                  return false;
                                }
                              } else {
        ...
        Fixtures.withCached(undefined, undefined, "Watcher__CustodianKeyChain", "Keeps increasing the index accross multiple removals", (function () {
                return Generators.withUserSessions(2);
              }), (function (sessions) {
                var match = Generators.twoUserSessionsFromArray(sessions);
                var user2 = match[1];
                ...
                return WatcherHelpers.testWatcherHasEventPending("CustodianKeyChainUpdated", watcher, user1[/* issuerKeyPair */2], (function (param) {
                              if (param.tag === 37) {
                                var match = param[0];
                                if (PrimitiveTypes.ProcessId[/* eq */5](match[/* custodianApprovalProcess */0], acceptance[/* processId */0]) && PrimitiveTypes.UserId[/* eq */5](match[/* custodianId */1], user1[/* userId */0])) {
                                  return keyChainEq(Generators.custodianKeyChain(undefined, Generators.Log[/* ventureId */2](log), 1, user1), match[/* keyChain */2]);
                                } else {
                                  return false;
                                }
                              } else {
        ...
        describe("Completion", (function () {
                Fixtures.withCached(undefined, undefined, "Watcher__CustodianKeyChain", "when the custodian is a different user", (function () {
                        return Generators.withUserSessions(2);
                      }), (function (sessions) {
                        var match = Generators.twoUserSessionsFromArray(sessions);
                        var user2 = match[1];
                ...
                Fixtures.withCached(undefined, undefined, "Watcher__CustodianKeyChain", "when the custodian is removed", (function () {
                        return Generators.withUserSessions(2);
                      }), (function (sessions) {
                        var match = Generators.twoUserSessionsFromArray(sessions);
                        var user2 = match[1];
                ...
                Fixtures.withCached(undefined, undefined, "Watcher__CustodianKeyChain", "when the partner is removed", (function () {
                        return Generators.withUserSessions(2);
                      }), (function (sessions) {
                        var match = Generators.twoUserSessionsFromArray(sessions);
                        var user2 = match[1];
                ...
                return Fixtures.withCached(undefined, undefined, "Watcher__CustodianKeyChain", "when the partner has no pubkey", (function () {
                              return Generators.withUserSessions(2);
                            }), (function (sessions) {
                              var match = Generators.twoUserSessionsFromArray(sessions);
                              var user2 = match[1];
