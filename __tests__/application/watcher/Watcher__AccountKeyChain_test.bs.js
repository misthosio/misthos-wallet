...
describe("Watcher__AccountKeyChain", (function () {
        describe("Identifies a key chain when a custodian key chain changes", (function () {
                ...
                var log$1 = Generators.Log[/* withCustodianKeyChain */38](/* None */0, /* None */0, /* None */0, user1, Generators.Log[/* withCustodian */33](user1, /* :: */[
                          user1,
                          /* [] */0
                        ], log));
        ...
        describe("Identifies a key chain when a partner is removed", (function () {
                ...
                var log$1 = Generators.Log[/* withCustodianKeyChain */38](/* Some */[1], /* None */0, /* None */0, user1, Generators.Log[/* withPartnerRemoved */23](user2, /* :: */[
                          user1,
                          /* [] */0
        ...
        describe("Is idle when the partner is removed", (function () {
                ...
                var log$1 = Generators.Log[/* withCustodianKeyChain */38](/* None */0, /* None */0, /* None */0, user2, Generators.Log[/* withPartnerRemoved */23](user1, /* :: */[
                          user2,
                          /* [] */0
        ...
        describe("Is idle when the custodian is removed", (function () {
                ...
                var log$1 = Generators.Log[/* withCustodianKeyChain */38](/* None */0, /* None */0, /* None */0, user2, Generators.Log[/* withCustodianRemoved */37](user1, /* :: */[
                          user2,
                          /* [] */0
                        ], Generators.Log[/* withCustodian */33](user2, /* :: */[
                              user1,
