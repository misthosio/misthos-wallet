...
describe("Watcher__AccountKeyChain", (function () {
        Fixtures.withCached(undefined, undefined, "Watcher__AccountKeyChain", "Identifies a key chain when a custodian key chain changes", (function () {
                ...
                var log$1 = Generators.Log[/* withCustodianKeyChain */38](undefined, undefined, user1, Generators.Log[/* withCustodian */33](user1, /* :: */[
                          user1,
                          /* [] */0
                        ], log));
        ...
        Fixtures.withCached(undefined, undefined, "Watcher__AccountKeyChain", "Identifies a key chain when a partner is removed", (function () {
                return Fixtures.threeUserSessionsArray;
              }), (function (sessions) {
                var match = Generators.twoUserSessionsFromArray(sessions);
                var user1 = match[0];
                ...
                var log$1 = Generators.Log[/* withCustodianKeyChain */38](1, undefined, user1, Generators.Log[/* withPartnerRemoved */23](user2, /* :: */[
                          user1,
                          /* [] */0
        ...
        Fixtures.withCached(undefined, undefined, "Watcher__AccountKeyChain", "Activates a key chain when a custodian key chain changes", (function () {
                return Fixtures.threeUserSessionsArray;
              }), (function (sessions) {
                var match = Generators.twoUserSessionsFromArray(sessions);
                var user1 = match[0];
        ...
        Fixtures.withCached(undefined, undefined, "Watcher__AccountKeyChain", "Is idle when the key chain has been activated", (function () {
                return Fixtures.threeUserSessionsArray;
              }), (function (sessions) {
                var match = Generators.twoUserSessionsFromArray(sessions);
                var user1 = match[0];
        ...
        Fixtures.withCached(undefined, undefined, "Watcher__AccountKeyChain", "Activates a key chain when a custodian is removed", (function () {
                return Fixtures.threeUserSessionsArray;
              }), (function (sessions) {
                var match = Generators.twoUserSessionsFromArray(sessions);
                var user1 = match[0];
        ...
        Fixtures.withCached(undefined, undefined, "Watcher__AccountKeyChain", "Is idle when the partner is removed", (function () {
                return Fixtures.threeUserSessionsArray;
              }), (function (sessions) {
                var match = Generators.twoUserSessionsFromArray(sessions);
                var user1 = match[0];
                ...
                var log$1 = Generators.Log[/* withCustodianKeyChain */38](undefined, undefined, user2, Generators.Log[/* withPartnerRemoved */23](user1, /* :: */[
                          user2,
                          /* [] */0
        ...
        return Fixtures.withCached(undefined, undefined, "Watcher__AccountKeyChain", "Is idle when the custodian is removed", (function () {
                      return Fixtures.threeUserSessionsArray;
                    }), (function (sessions) {
                      var match = Generators.twoUserSessionsFromArray(sessions);
                      var user1 = match[0];
                      ...
                      var log$1 = Generators.Log[/* withCustodianKeyChain */38](undefined, undefined, user2, Generators.Log[/* withCustodianRemoved */37](user1, /* :: */[
                                user2,
                                /* [] */0
                              ], Generators.Log[/* withCustodian */33](user2, /* :: */[
                                    user1,
