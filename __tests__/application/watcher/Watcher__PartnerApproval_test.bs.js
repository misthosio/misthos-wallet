...
describe("Will approve the creator", (function () {
        ...
        var log = Generators.Log[/* withPartnerProposed */8](user1, user1)(Generators.Log[/* createVenture */7](user1));
...
describe("With 1 partner and a proposal", (function () {
        ...
        var user1 = match[0];
        var log = Generators.Log[/* withPartnerProposed */8](user1, match[1])(Generators.Log[/* withFirstPartner */12](user1)(Generators.Log[/* createVenture */7](user1)));
        var proposal = Event.getPartnerProposedExn(Generators.Log[/* lastEvent */3](log));
        var watcher = Watcher__PartnerApproval.make(proposal, Generators.Log[/* eventLog */4](log));
        return WatcherHelpers.testWatcherHasEventPending("PartnerAccepted", watcher, Generators.Log[/* systemIssuer */1](log), (function (param) {
                      if (param.tag === 3) {
...
describe("With 2 users and a proposal", (function () {
        ...
        var user1 = match[0];
        var log = Generators.Log[/* withPartnerProposed */8](user1, match[2])(Generators.Log[/* withPartner */11](match[1], /* :: */[
                  user1,
                  /* [] */0
...
describe("With 2 users and a proposal and endorsement", (function () {
        ...
        var user2 = match[1];
        var user1 = match[0];
        var log = Generators.Log[/* withPartnerProposed */8](user1, match[2])(Generators.Log[/* withPartner */11](user2, /* :: */[
                  user1,
                  /* [] */0
                ], Generators.Log[/* withFirstPartner */12](user1)(Generators.Log[/* createVenture */7](user1))));
        var proposal = Event.getPartnerProposedExn(Generators.Log[/* lastEvent */3](log));
...
describe("With 2 users and a removal and a proposal", (function () {
        ...
        var user2 = match[1];
        var user1 = match[0];
        var log = Generators.Log[/* withPartnerProposed */8](user1, match[2])(Generators.Log[/* withPartnerRemoved */16](user2, /* :: */[
                  user1,
                  /* [] */0
