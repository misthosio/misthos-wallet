...
describe("With 1 partner and a proposal", (function () {
        ...
        var log = Generators.Log[/* withCustodianProposed */23](user1, user1, Generators.Log[/* withFirstPartner */15](user1)(Generators.Log[/* createVenture */9](user1)));
...
describe("Completes when the custodian is accepted", (function () {
        ...
        var proposal = Event.getCustodianProposedExn(Generators.Log[/* lastEvent */4](log));
        var watcher = Watcher__CustodianApproval.make(proposal, Generators.Log[/* eventLog */5](log));
        var log$1 = Generators.Log[/* withCustodianAccepted */25](proposal)(log);
...
describe("With 2 users and a proposal and endorsement", (function () {
        ...
        var proposal = Event.getCustodianProposedExn(Generators.Log[/* lastEvent */4](log));
        var log$1 = Generators.Log[/* withCustodianEndorsed */24](user2, proposal)(log);
...
describe("With 2 users and a removal and a proposal", (function () {
        ...
        var user2 = match[1];
        var user1 = match[0];
        var log = Generators.Log[/* withCustodianProposed */23](user1, user1, Generators.Log[/* withPartnerRemoved */19](user2, /* :: */[
                  user1,
                  /* [] */0
...
describe("With 2 users and a proposal and a removal", (function () {
        ...
        var user2 = match[1];
        var user1 = match[0];
        var log = Generators.Log[/* withCustodianProposed */23](user1, user1, Generators.Log[/* withPartner */14](user2, /* :: */[
                  user1,
                  /* [] */0
                ], Generators.Log[/* withFirstPartner */15](user1)(Generators.Log[/* createVenture */9](user1))));
        var proposal = Event.getCustodianProposedExn(Generators.Log[/* lastEvent */4](log));
