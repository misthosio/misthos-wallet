...
var Watcher__AccountKeyChain_ALT = require("../../../src/application/watcher/Watcher__AccountKeyChain_ALT.bs.js");
...
describe("Identifies a key chain when a custodian key chain changes", (function () {
        ...
        var watcher = Watcher__AccountKeyChain_ALT.make(user1, acceptance, Generators.Log[/* eventLog */5](log$1));
...
describe("Activates a key chain when a custodian key chain changes", (function () {
        ...
        var log = Generators.Log[/* withAccount */22](user1, Generators.Log[/* withFirstPartner */15](user1)(Fixtures.createVenture(user1)));
        var acceptance = Event.getAccountCreationAcceptedExn(Generators.Log[/* lastEvent */4](log));
        var log$1 = Generators.Log[/* withAccountKeyChainIdentified */33](Generators.Log[/* withCustodianKeyChain */31](/* None */0, /* None */0, user1, Generators.Log[/* withCustodian */26](user1, /* :: */[
                      user1,
                      /* [] */0
                    ], log)));
        var watcher = Watcher__AccountKeyChain_ALT.make(user1, acceptance, Generators.Log[/* eventLog */5](log$1));
...
describe("Is idle when the key chain has been activated", (function () {
        ...
        var log = Generators.Log[/* withAccount */22](user1, Generators.Log[/* withFirstPartner */15](user1)(Fixtures.createVenture(user1)));
        var acceptance = Event.getAccountCreationAcceptedExn(Generators.Log[/* lastEvent */4](log));
        var log$1 = Generators.Log[/* withAccountKeyChainActivated */34](user1, Generators.Log[/* withAccountKeyChainIdentified */33](Generators.Log[/* withCustodianKeyChain */31](/* None */0, /* None */0, user1, Generators.Log[/* withCustodian */26](user1, /* :: */[
                          user1,
                          /* [] */0
                        ], log))));
        return WatcherHelpers.testWatcherHasNoEventPending(Watcher__AccountKeyChain_ALT.make(user1, acceptance, Generators.Log[/* eventLog */5](log$1)));
      }));
...
describe("Activates a key chain when a custodian is removed", (function () {
        ...
        var log$1 = Generators.Log[/* withCustodianRemoved */30](user2, /* :: */[
              user1,
              /* [] */0
            ], Generators.Log[/* withAccountKeyChainActivated */34](user1, Generators.Log[/* withAccountKeyChainIdentified */33](Generators.Log[/* withCustodianKeyChain */31](/* None */0, /* None */0, user2, Generators.Log[/* withCustodian */26](user2, /* :: */[
                              user1,
                              /* :: */[
                                user2,
                                /* [] */0
                                  ...
                                  user1,
                                  /* [] */0
                                ], Generators.Log[/* withAccountKeyChainActivated */34](user1, Generators.Log[/* withAccountKeyChainIdentified */33](Generators.Log[/* withCustodianKeyChain */31](/* None */0, /* None */0, user1, Generators.Log[/* withCustodian */26](user1, /* :: */[
                                                  user1,
                                                  /* [] */0
                                                ], log))))))))));
        var watcher = Watcher__AccountKeyChain_ALT.make(user1, acceptance, Generators.Log[/* eventLog */5](log$1));
