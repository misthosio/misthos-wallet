...
describe("RemovalProcessMapping", (function () {
        ...
        return Jest.test("maps a partnerRemovalProcess to a custodianRemovalProcess", (function () {
                      return Jest.Expect[/* toEqual */12](Js_primitive.some(custodianRemovalProcess), Jest.Expect[/* expect */0](Venture__State.custodianRemovalProcessForPartnerRemovalProcess(partnerRemovalProcess, state)));
                    }));
      }));
