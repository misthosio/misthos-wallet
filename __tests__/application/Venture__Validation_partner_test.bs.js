...
Jest.describe("PartnerProposal", (function (param) {
        Jest.describe("when proposing another partner", (function (param) {
        ...
        Jest.describe("when the prospect is already a partner", (function (param) {
                var match = Generators.twoUserSessions(/* () */0);
                var user2 = match[1];
                var user1 = match[0];
        ...
        Jest.describe("when the creator proposes themselves", (function (param) {
        ...
        Jest.describe("when proposing a partner that was removed", (function (param) {
                var match = Generators.twoUserSessions(/* () */0);
                var user2 = match[1];
                var user1 = match[0];
        ...
        return Jest.describe("when the partner was removed but the proposal doesn't show it", (function (param) {
...
Jest.describe("PartnerRemovalProposal", (function (param) {
        Jest.describe("when proposing another partner", (function (param) {
                var match = Generators.twoUserSessions(/* () */0);
                var user2 = match[1];
                var user1 = match[0];
        ...
        return Jest.describe("validatePartnerRemovalData", (function (param) {
                      Jest.describe("when the prospect is not a partner", (function (param) {
                              var match = Generators.twoUserSessions(/* () */0);
                              var user2 = match[1];
                              var user1 = match[0];
                              var log = Generators.Log[/* withFirstPartner */18](user1)(Generators.Log[/* createVenture */11](user1));
                      ...
                      return Jest.describe("when lastPartnerProcess doesn't match", (function (param) {
                                    var match = Generators.twoUserSessions(/* () */0);
                                    var user2 = match[1];
                                    var user1 = match[0];
                                    var log = Generators.Log[/* withPartner */17](undefined, user2, /* :: */[
...
Jest.describe("PartnerPubKeyAdded", (function (param) {
        Jest.describe("when everything is okay", (function (param) {
                var match = Generators.twoUserSessions(/* () */0);
                var user2 = match[1];
                var user1 = match[0];
        ...
        Jest.describe("when the partner submits an event", (function (param) {
                var match = Generators.threeUserSessions(/* () */0);
                var user3 = match[2];
                var user2 = match[1];
                var user1 = match[0];
        ...
        Jest.describe("when syncing from another user", (function (param) {
                var match = Generators.twoUserSessions(/* () */0);
                var user2 = match[1];
                var user1 = match[0];
                var log = Generators.Log[/* withPartner */17](false, user2, /* :: */[
        ...
        Jest.describe("when the partner hasn't been accepted", (function (param) {
                var match = Generators.twoUserSessions(/* () */0);
                var user2 = match[1];
                var user1 = match[0];
                var func = Generators.Log[/* withPartnerProposed */12];
        ...
        return Jest.describe("when the pub key is already known", (function (param) {
                      var match = Generators.twoUserSessions(/* () */0);
                      var user2 = match[1];
                      var user1 = match[0];
                      var log = Generators.Log[/* withPartner */17](undefined, user2, /* :: */[
