...
describe("PartnerProposal", (function () {
        ...
        describe("when the prospect is already a partner", (function () {
                ...
                var user2 = match[1];
                var user1 = match[0];
                var log = Generators.Log[/* withPartner */17](/* None */0, user2, /* :: */[
                      user1,
                      /* [] */0
                ...
                return ValidationHelpers.testValidationResult(/* None */0, ValidationHelpers.constructState(/* None */0, log), Generators.Log[/* lastItem */4](Curry._1((function (param, param$1, param$2, param$3) {
                                      ...
                                      })(/* None */0, /* None */0, /* None */0, /* None */0), log)), /* BadData */["Partner already exists"]);
              }));
        ...
        describe("when the partner was removed but the proposal doesn't show it", (function () {
                ...
                return ValidationHelpers.testValidationResult(/* None */0, ValidationHelpers.constructState(/* None */0, log), Generators.Log[/* lastItem */4](Curry._1((function (param, param$1, param$2) {
                                        return Curry._6(func, param, /* Some */[false], param$1, param$2, user3, user2);
                                      })(/* None */0, /* None */0, /* None */0), log)), /* BadData */["Last removal doesn't match"]);
              }));
        return /* () */0;
      }));
...
describe("PartnerRemovalProposal", (function () {
        describe("when proposing another partner", (function () {
                ...
                return ValidationHelpers.testValidationResult(/* None */0, ValidationHelpers.constructState(/* None */0, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerRemovalProposed */19](user1, user2, log)), /* Ok */0);
              }));
        describe("validatePartnerRemovalData", (function () {
                describe("when the prospect is not a partner", (function () {
                        ...
                        var user1 = match[0];
                        var log = Generators.Log[/* withFirstPartner */18](user1)(Generators.Log[/* createVenture */11](user1));
                        return ValidationHelpers.testDataValidation(Venture__Validation.validatePartnerRemovalData, ValidationHelpers.constructState(/* None */0, log), /* record */[
                                    /* id */user2[/* userId */0],
...
describe("PartnerPubKeyAdded", (function () {
        describe("when everything is okay", (function () {
                ...
                var user2 = match[1];
                var user1 = match[0];
                var log = Generators.Log[/* withPartner */17](/* Some */[false], user2, /* :: */[
                      user1,
                      /* [] */0
                    ], Generators.Log[/* withFirstPartner */18](user1)(Generators.Log[/* createVenture */11](user1)));
        ...
        describe("when the partner submits an event", (function () {
                ...
                var user2 = match[1];
                var user1 = match[0];
                var log = Generators.Log[/* withPartnerPubKeyAdded */20](user2)(Generators.Log[/* withPartner */17](/* Some */[false], user2, /* :: */[
                          user1,
                          /* [] */0
                        ], Generators.Log[/* withFirstPartner */18](user1)(Generators.Log[/* createVenture */11](user1))));
                var func = Generators.Log[/* withPartnerProposed */12];
                return ValidationHelpers.testValidationResult(/* None */0, ValidationHelpers.constructState(/* Some */[user2[/* userId */0]], log), Generators.Log[/* lastItem */4](Curry._1((function (param, param$1, param$2, param$3) {
        ...
        describe("when syncing from another user", (function () {
                ...
                return ValidationHelpers.testValidationResult(/* Some */[user1[/* userId */0]], ValidationHelpers.constructState(/* None */0, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerPubKeyAdded */20](user2)(log)), /* InvalidIssuer */2);
              }));
        describe("when the partner hasn't been accepted", (function () {
                ...
                var arg = function (param, param$1, param$2) {
                  return Curry._6(func, /* Some */[false], param, param$1, param$2, user1, user2);
                };
                var log = (function (eta) {
                      return Curry._1(arg(/* None */0, /* None */0, /* None */0), eta);
                    })(Generators.Log[/* withFirstPartner */18](user1)(Generators.Log[/* createVenture */11](user1)));
        ...
        describe("when the pub key is already known", (function () {
                ...
                return ValidationHelpers.testValidationResult(/* Some */[user2[/* userId */0]], ValidationHelpers.constructState(/* None */0, log), Generators.Log[/* lastItem */4](Generators.Log[/* withPartnerPubKeyAdded */20](user2)(log)), /* BadData */["Partner pub key is already known"]);
              }));
        return /* () */0;
      }));
