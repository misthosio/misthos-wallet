...
function testNextIncomeAddress(user, address, wallet) {
  ...
  return Venture__Wallet.apply(/* IncomeAddressExposed */Block.__(41, [exposed]), wallet);
}
...
function collectNextTwoAddresses(user, param) {
  ...
  var log = Generators.Log[/* appendSystemEvent */8](/* IncomeAddressExposed */Block.__(41, [exposed1]), param[1]);
  var wallet$1 = Venture__Wallet.apply(/* IncomeAddressExposed */Block.__(41, [exposed1]), wallet);
  var exposed2 = Venture__Wallet.exposeNextIncomeAddress(user[/* userId */0], WalletTypes.AccountIndex[/* default */11], wallet$1);
  var log$1 = Generators.Log[/* appendSystemEvent */8](/* IncomeAddressExposed */Block.__(41, [exposed2]), log);
  var wallet$2 = Venture__Wallet.apply(/* IncomeAddressExposed */Block.__(41, [exposed2]), wallet$1);
  return /* tuple */[
          /* tuple */[
            exposed1,
            exposed2
