...
function testNextIncomeAddress(user, address, wallet) {
  ...
  return Venture__Wallet.apply(/* IncomeAddressExposed */Block.__(33, [exposed]), wallet);
}
...
function collectNextTwoAddresses(user, param) {
  ...
  var log = Generators.Log[/* appendSystemEvent */7](/* IncomeAddressExposed */Block.__(33, [exposed]), param[1]);
  var wallet$1 = Venture__Wallet.apply(/* IncomeAddressExposed */Block.__(33, [exposed]), wallet);
  ...
  var log$1 = Generators.Log[/* appendSystemEvent */7](/* IncomeAddressExposed */Block.__(33, [exposed$1]), log);
  var wallet$2 = Venture__Wallet.apply(/* IncomeAddressExposed */Block.__(33, [exposed$1]), wallet$1);
  return /* tuple */[
          /* tuple */[
            address1,
            address2
