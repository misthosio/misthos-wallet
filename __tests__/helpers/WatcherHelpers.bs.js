...
function testWatcherHasCompleted(watcher) {
  return Jest.test("the watcher has completed", (function () {
                return Jest.Expect[/* toEqual */12](/* true */1, Jest.Expect[/* expect */0](Caml_oo_curry.js2(111581468, 1, watcher, /* () */0)));
              }));
}

function testWatcherHasNotCompleted(watcher) {
  return Jest.test("the watcher has not completed", (function () {
                return Jest.Expect[/* toEqual */12](/* false */0, Jest.Expect[/* expect */0](Caml_oo_curry.js2(111581468, 2, watcher, /* () */0)));
              }));
}
...
function testWatcherHasNoEventPending(watcher) {
  ...
  return Jest.test("and has no event pending", (function () {
                return Jest.Expect[/* toEqual */12](/* true */1, Jest.Expect[/* expect */0](Js_option.isNone(Caml_oo_curry.js2(761988163, 3, watcher, /* () */0))));
              }));
}
