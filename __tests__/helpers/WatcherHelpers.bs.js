...
function testWatcherHasCompleted(watcher) {
  return Jest.test("the watcher has completed", (function (param) {
...
function testWatcherHasNotCompleted(watcher) {
  return Jest.test("the watcher has not completed", (function (param) {
...
function testWatcherHasNoEventPending(watcher) {
  ...
  return Jest.test("and has no event pending", (function (param) {
...
function testWatcherHasEventPending(eventName, watcher, expectedIssuer, eventTest) {
  testWatcherHasNotCompleted(watcher);
  return Jest.test("and has " + (eventName + " pending"), (function (param) {
                var param$1 = Js_option.getExn(Caml_oo_curry.js2(761988163, 4, watcher, /* () */0));
                return Jest.Expect[/* toEqual */12](/* tuple */[
                            expectedIssuer,
                            true
                          ], Jest.Expect[/* expect */0](/* tuple */[
                                param$1[0],
                                Curry._1(eventTest, param$1[1])
                              ]));
              }));
}
