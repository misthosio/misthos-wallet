...
describe("Wallet_integration", (function () {
        return Fixtures.withCached(undefined, undefined, "Wallet_integration", "integration", (function () {
                      return Generators.withUserSessions(3);
                    }), (function (sessions) {
                      var match = Generators.threeUserSessionsFromArray(sessions);
                      var user2 = match[1];
                      var user1 = match[0];
                      return Generators.Log[/* withAccountKeyChainActivated */40](undefined, user2, Generators.Log[/* withAccountKeyChainActivated */40](undefined, user1, Generators.Log[/* withAccountKeyChainIdentified */39](4, Generators.Log[/* withCustodianKeyChain */38](undefined, undefined, user2, Generators.Log[/* withCustodianKeyChain */38](undefined, undefined, user1, Generators.Log[/* withCustodian */33](user2, /* :: */[
                                                      user1,
                                                      /* :: */[
                                                        user2,
                                                        /* [] */0
                      ...
                      Jest.beforeAllPromise(40000, (function () {
                      ...
                      return Jest.testPromise(80000, "2 of 3 wallet", (function () {
                                    Helpers.genBlocks(4);
                                    var param = Venture__Wallet.preparePayoutTx(Belt_Set.mergeMany(PrimitiveTypes.UserId[/* emptySet */9], /* array */[
                                              user1[/* userId */0],
                                              user2[/* userId */0],
