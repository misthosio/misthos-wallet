...
describe("Wallet_integration", (function () {
        return Fixtures.withCached(/* None */0, "Wallet_integration", "integration", (function () {
                      ...
                      var user2 = match[1];
                      var user1 = match[0];
                      return Generators.Log[/* withAccountKeyChainActivated */36](/* None */0, user2, Generators.Log[/* withAccountKeyChainActivated */36](/* None */0, user1, Generators.Log[/* withAccountKeyChainIdentified */35](Generators.Log[/* withCustodianKeyChain */34](/* None */0, /* None */0, user2, Generators.Log[/* withCustodianKeyChain */34](/* None */0, /* None */0, user1, Generators.Log[/* withCustodian */29](user2, /* :: */[
                                                      user1,
                                                      /* :: */[
                                                        user2,
                                                        /* [] */0
                      ...
                      var log$1 = Generators.Log[/* withAccountKeyChainActivated */36](/* None */0, user3, Generators.Log[/* withAccountKeyChainActivated */36](/* None */0, user2, Generators.Log[/* withAccountKeyChainActivated */36](/* None */0, user1, Generators.Log[/* withAccountKeyChainIdentified */35](Generators.Log[/* withCustodianKeyChain */34](/* None */0, /* None */0, user3, Generators.Log[/* withCustodian */29](user3, /* :: */[
                                                user1,
                                                /* :: */[
                                                  user2,
                                                  /* [] */0
                      ...
                      Jest.beforeAllPromise(/* Some */[40000], (function () {
                              return Helpers.faucet(/* :: */[
                                              ...
                                              List.iter((function (param) {
                                                      ...
                                                      if (match) {
                                                        oneKeyChainWallet[0] = Venture__Wallet.apply(/* IncomeDetected */Block.__(34, [incomeEvent]), oneKeyChainWallet[0]);
                                                        twoKeyChainWallet[0] = Venture__Wallet.apply(/* IncomeDetected */Block.__(34, [incomeEvent]), twoKeyChainWallet[0]);
                                                        return /* () */0;
                                                      } else {
                                                        twoKeyChainWallet[0] = Venture__Wallet.apply(/* IncomeDetected */Block.__(34, [incomeEvent]), twoKeyChainWallet[0]);
                                                        return /* () */0;
                                              ...
                                              if (param) {
                                                var $$event = param[0];
                                                oneKeyChainWallet[0] = Venture__Wallet.apply(/* PayoutProposed */Block.__(22, [$$event]), oneKeyChainWallet[0]);
                                                twoKeyChainWallet[0] = Venture__Wallet.apply(/* PayoutProposed */Block.__(22, [$$event]), twoKeyChainWallet[0]);
                                            ...
                                            oneKeyChainWallet[0] = Venture__Wallet.apply(/* PayoutBroadcast */Block.__(27, [Curry._2(Event.Payout[/* Broadcast */9][/* make */0], processId, txId)]), oneKeyChainWallet[0]);
                                            twoKeyChainWallet[0] = Venture__Wallet.apply(/* PayoutBroadcast */Block.__(27, [Curry._2(Event.Payout[/* Broadcast */9][/* make */0], processId, txId)]), twoKeyChainWallet[0]);
                      ...
                      return Jest.testPromise(/* Some */[80000], "2 of 3 wallet", (function () {
                                    ...
                                    if (param) {
                                      ...
                                      tmp = Promise.all(/* tuple */[
                                            Promise.resolve(Venture__Wallet.apply(/* PayoutProposed */Block.__(22, [$$event]), twoKeyChainWallet[0])),
                                            Helpers.broadcastTransaction(PayoutTransaction.finalize(/* :: */[
                                                      data[/* payoutTx */1],
                                                      /* :: */[
                                                        payoutTx,
