        ...
        area3={
          <div
            ...
            <ScrollList>
              ...
              (T.section17P1 |> wrapWithDiv)
              (T.section17P2 |> paragraph)
              (T.section17P3 |> paragraph)
              (T.section17P4 |> wrapWithDiv)
              (T.section17P5 |> wrapWithDiv)
              (T.section17P6 |> wrapWithDiv)
              ...
              (T.section20P3 |> paragraph)
              (T.section20P4 |> paragraph)
              (T.section20P5 |> paragraph)
              (T.section20P6 |> paragraph)
              (T.section20P7 |> wrapWithDiv)
              (T.section20P8 |> paragraph)
              (T.section20P9 |> wrapWithDiv)
              (T.section20P10 |> paragraph)
              (T.section20P11 |> wrapWithDiv)
              (T.section21Heading |> subheading)
              (T.section21P1 |> paragraph)
              (T.section21P2 |> wrapWithDiv)
              (T.section21P3 |> paragraph)
              (T.section21P4 |> paragraph)
              (T.section21P6 |> wrapWithDiv)
