  ...
  return /* record */[
          ...
          /* render */(function () {
              return ReasonReact.element(/* None */0, /* None */0, Layout.make(/* None */0, /* None */0, /* Some */[true], /* array */[
                              ReasonReact.element(/* None */0, /* None */0, Grid.make(/* Some */[ViewCommon.text(Text.DatenschutzErklaerung[/* title */0])], /* None */0, /* None */0, /* None */0, /* Some */[React.createElement("div", undefined, line(Text.DatenschutzErklaerung[/* section1 */1]), subheading(Text.DatenschutzErklaerung[/* section2Heading */2]), line("Justin Carter"), line("Misthos"), line("Dolziger Str. 15"), line("D10247 Berlin"), line("Deutschland"), ReasonReact.element(/* None */0, /* None */0, MTypography.make(/* Body1 */-904051921, /* None */0, /* None */0, /* None */0, /* array */[
