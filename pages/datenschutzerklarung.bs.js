...
function subheading(data) {
  return ReasonReact.element(undefined, undefined, MTypography.make(/* Subheading */148169314, undefined, true, true, undefined, /* array */[ViewCommon.text(data)]));
}
              ...
              return ReasonReact.element(undefined, undefined, Layout.make(Js_primitive.some(ReasonReact.element(undefined, undefined, Header.make(undefined, environment[/* webDomain */3] + "/", undefined, /* array */[]))), undefined, undefined, true, /* array */[
                              ReasonReact.element(undefined, undefined, Grid.make(Js_primitive.some(ViewCommon.text(DatenschutzText.title)), undefined, undefined, undefined, Js_primitive.some(React.createElement("div", {
                                                className: ScrollList.containerStyles + (" " + Css.style(/* :: */[
                                                        ...
                                                        React.createElement("div", undefined, line("Justin Carter"), line("Misthos"), line("Dolziger Str. 15"), line("D10247 Berlin"), line("Deutschland"), ReasonReact.element(undefined, undefined, MTypography.make(/* Body1 */-904051921, undefined, undefined, undefined, undefined, /* array */[
                                                                      ViewCommon.text("Email: "),
                                                                      React.createElement("a", {
                                                                            href: "mailto:Contact@misthos.io"
                                                                          }, ViewCommon.text("contact@misthos.io"))
                                                                    ])), ReasonReact.element(undefined, undefined, MTypography.make(/* Body1 */-904051921, undefined, undefined, undefined, undefined, /* array */[
