...
function line(data) {
  return ReasonReact.element(undefined, undefined, MTypography.make(/* Body1 */-904051921, undefined, undefined, undefined, /* `String */[
                  -976970511,
                  "span"
                ], undefined, /* array */[ViewCommon.text(data)]));
}
...
function subheading(data) {
  return ReasonReact.element(undefined, undefined, MTypography.make(/* Subheading */148169314, undefined, true, true, undefined, undefined, /* array */[ViewCommon.text(data)]));
}
  ...
  return /* record */[
          ...
          /* render */(function (param) {
              return ReasonReact.element(undefined, undefined, PageLayout.make(/* array */[ReasonReact.element(undefined, undefined, Layout.make(Caml_option.some(ReasonReact.element(undefined, undefined, Header.make(undefined, environment[/* webDomain */3] + "/", undefined, /* array */[]))), undefined, undefined, /* array */[
                                        ReasonReact.element(undefined, undefined, Grid.make(Caml_option.some(ViewCommon.text(DatenschutzText.title)), undefined, undefined, undefined, Caml_option.some(React.createElement("div", {
