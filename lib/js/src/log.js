...
function Make(Item) {
  var createEvent = function (issuerKeyPair, payload) {
    ...
    var signature = issuerKeyPair.sign(payloadHashBuffer);
    return /* record */[
            /* payload */payload,
                      ...
                      /* :: */[
                        ...
                        /* :: */[
                          ...
                          /* :: */[
                            /* tuple */[
                              "signature",
                              $$event$1[/* signature */4].toDER().toString("hex")
                            ],
                            /* [] */0
                          ]
                        ]
  ...
  var signature = function (json) {
    return BitcoinjsLib.ECSignature.fromDER((function (param) {
  ...
  var $$event$1 = function (raw) {
    ...
    return /* record */[
            ...
            /* signature */Json_decode.field("signature", signature, json)
          ];
  };
  var Decode = /* module */[
    /* signature */signature,
