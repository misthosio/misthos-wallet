...
describe("Encode/Decode", (function () {
        Jest.test("StringEvent", (function () {
                ...
                var decoded = Curry._1(TestLog[/* Decode */3][/* event */1], Curry._1(TestLog[/* Encode */2][/* event */0], $$event));
                return Jest.Expect[/* toEqual */12](decoded[/* payload */0])(Jest.Expect[/* expect */0]($$event[/* payload */0]));
              }));
...
Jest.test("sign/verify", (function () {
        var $$event = Curry._2(TestLog[/* createEvent */0], keyPair, /* StringEvent */Block.__(0, ["hello"]));
        var decoded = Curry._1(TestLog[/* Decode */3][/* event */1], Curry._1(TestLog[/* Encode */2][/* event */0], $$event));
        var verified = keyPair.verify((function (param) {
                  return Buffer.from(param, "hex");
                })(decoded[/* payloadHash */2]), decoded[/* signature */4]);
